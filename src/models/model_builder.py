...
class PTSEFormer(nn.Module):
    def __init__(self, cfg):
        ...
        self.corr = OursDecoderV2(num_layers=2)  # 黄色模块
    ...
    def init_paras(self):
        # 将模型的参数初始化为适当的值，以便在训练过程中获得良好的收敛性和性能。
        prior_prob = 0.01
    ...
    def forward(self, samples_dict: dict):
        ...
        # mem_cur_stg2表示第二阶段产生的h_t, mem_ref_stg2_cat表示第二阶段产生的一些f_t
        mem_cur_stg3 = []
